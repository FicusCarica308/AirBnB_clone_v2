...
@flask_app.route('/', strict_slashes=False)  # 1
def print_greet():
    """ Returns String "Hello HBNB!" when route is landed upon """
    return "Hello HBNB!"


@flask_app.route('/hbnb')  # 2
def print_hbnb():
    """ Returns String "HBNB" """
    return "HBNB"


@flask_app.route('/c/<text>')  # 3
def print_text(text):
